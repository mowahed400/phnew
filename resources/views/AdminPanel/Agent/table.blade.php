...
<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
    ...
    <tbody>
        @foreach ($agents as $agent)
            <tr>
                <td>
                    <span class="badge badge-light-success fs-7 fw-bold">{{ $agent->name }}</span>
                </td>
                <td>
                    <span class="badge badge-light-success fs-7 fw-bold">{{ $agent->user->name }}</span>
                </td>


                <td>
                        <a href="{{ route('agent.edit', $agent->id) }}" class="btn btn-sm btn-light me-2">
